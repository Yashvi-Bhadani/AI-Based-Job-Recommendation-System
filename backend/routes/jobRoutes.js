...
// GET all saved jobs for logged-in user, grouped by location
// Query params: ?resumeId=xxx&groupBy=city|state|country
router.get("/my", protect, getMyJobs);

// Toggle bookmark
router.patch("/:userJobId/save", protect, toggleSave);
